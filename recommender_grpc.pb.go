...
const (
	RecommenderBaseComment_AddComment_FullMethodName                       = "/recommender.RecommenderBaseComment/AddComment"
	RecommenderBaseComment_UpdateComment_FullMethodName                    = "/recommender.RecommenderBaseComment/UpdateComment"
	RecommenderBaseComment_DeleteComment_FullMethodName                    = "/recommender.RecommenderBaseComment/DeleteComment"
	RecommenderBaseComment_LisRecommendedProductIDsByUserID_FullMethodName = "/recommender.RecommenderBaseComment/LisRecommendedProductIDsByUserID"
)
...
var RecommenderBaseComment_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "recommender.RecommenderBaseComment",
